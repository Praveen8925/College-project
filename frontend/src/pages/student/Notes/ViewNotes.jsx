...
const EXT_ICON = {
  ...
  doc:  <Article sx={{ color:'#1565C0' }} />,
  docx: <Article sx={{ color:'#1565C0' }} />,
  ppt:  <Article sx={{ color:'#E65100' }} />,
  pptx: <Article sx={{ color:'#E65100' }} />,
};
...
export default function ViewNotes() {
  ...
  return (
    <Box sx={{ p:3 }}>
      <Typography variant="h5" fontWeight={700} mb={0.5}>Study Notes</Typography>
      ...
      {loading ? (
        ...
        <Box py={8} textAlign="center">
          <MenuBook sx={{ fontSize:56, color:'#ccc', mb:2 }} />
