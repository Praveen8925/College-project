...
export default function EventList() {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ bgcolor:'white', borderRadius:2, boxShadow:'0 2px 12px rgba(0,0,0,0.07)', overflow:'hidden' }}>
        {loading ? (
            ...
            {events.map((ev, i) => (
              <Box key={ev.EventID}>
                <ListItem sx={{ py:1.8, px:3 }}>
                  <Avatar sx={{ bgcolor:'#E8EAF6', color:'#1A237E', mr:2, width:36, height:36, fontSize:14, fontWeight:700 }}>
                    {ev.EventID}
                  </Avatar>
                  <ListItemText
