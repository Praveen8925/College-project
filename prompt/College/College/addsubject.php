...
<div class="allblur">
   ...
   <tr>
     <td colspan="2" align="Center"><h1>Add Program </h1>
   </tr>
   <tr>
...
<form name="subjectdetails" method="post" action="AddSubjectSave.php" onSubmit="return addsubject();" >
<tr>
<td>Batch</td>
...
<input type="radio" name="tp"  id="tp" value="Practical">Practical
</td>
</tr>
<tr>
<td>External Mark</td>
