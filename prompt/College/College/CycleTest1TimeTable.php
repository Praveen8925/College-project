...
<div class="allblur">
   ...
   <tr>
     <td colspan="2" align="Center"><h1>Cycle Test I Time Table</h1>
   </tr>
   <tr>
               ...
               $rs=mysql_query($SQL);  
                    if (mysql_num_rows($rs)==0)
                     ...
                     if($d=='n')
                       {
?>
<form name="cycletest1timetable" method="post" action="CycleTest1TimeTableSave.php" >
...
<?php
                      ...
                      $SQL="SELECT * FROM cycletest_1 WHERE  CourseID='$cid'";
                       $rm=mysql_query($SQL);
                        $decided="";
...
?>
<input type="Text" id="dat[<?php print $i; ?>]" name="dat[<?php print $i; ?>]" maxlength="10" size="10" value="<?php echo $c1date; ?>" <?php print $d; if($d==""){ ?> onClick="javascript:NewCssCal('dat[<?php print $i; ?>]','DDMMYYYY')" style="cursor:pointer" <?php } ?> /></td><td>
...
<br>
<br>
<input type="Submit" Value="Finalized" id="yn" name="yn" onClick="location.href='CycleTest1TimeTableSave.php'" class="bn">
<?php
}
                    }
                     else
