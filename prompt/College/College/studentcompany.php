...
<?php 
  if(isset($_SESSION['cstudents']))
    print $_SESSION['cstudents'];
  unset($_SESSION['cstudents']);
?></h4>
   </tr>
   </table>
<?php
...
$i=1;
$SQL="select * from upcompanies where Degree like '%$dept%' and Recruitment_type='OnCampus' ";    
$res=mysql_query($SQL);
...
<?php
$i=1;
$SQL="select * from upcompanies where Degree like '%$dept%' and Recruitment_type='OffCampus' ";    
$res=mysql_query($SQL);
