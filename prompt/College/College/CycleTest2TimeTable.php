...
<div class="allblur">
   ...
   <tr>
     <td colspan="2" align="Center"><h1>Cycle Test II Time Table</h1>
   </tr>
   <tr>
               ...
               $rs=mysql_query($SQL);  
                    if (mysql_num_rows($rs)==0)
                     ...
                     if($de=='n')
                       {
?>
<form name="cycletest2timetable" method="post" action="CycleTest2TimeTableSave.php" >
...
<?php
                      ...
                      $SQL="SELECT * FROM cycletest_2 WHERE  CourseID='$cid'";
                       $rm=mysql_query($SQL);
                        $decided="";
...
?>
<input type="Text" id="dat[<?php print $i; ?>]" name="dat[<?php print $i; ?>]" maxlength="10" size="10" value="<?php echo $c2date; ?>" <?php print $d; if($d==""){ ?> onClick="javascript:NewCssCal('dat[<?php print $i; ?>]','DDMMYYYY')" style="cursor:pointer" <?php } ?> /></td><td>
...
<tr>
<td colspan="2" >
<input type="Submit" Value="Finalized" id="yn" name="yn" onClick="location.href='CycleTest2TimeTableSave.php'" class="bn">
</td>
</tr>
<?php
  }                  }
