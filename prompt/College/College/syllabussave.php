...
if(isset($_FILES['syllabus']))
  {
	...
	if(in_array($file_ext,$expensions)=== false)
      ...
      {
          move_uploaded_file($file_tmp,"syllabus/".$file_name);
          $syllabus="syllabus/".$file_name;
	    rename("syllabus/".$file_name,$syllabus);
      }
   } 
   $sql="select * from syllabus where Batch='$batch'and Department='$dept' and Type='n'";
$res=mysql_query($sql);
 ...
 if (mysql_num_rows($res)>0)
  {    
	...
	{
		$SQL="insert into  syllabus  values('$batch','$dept','n','$syllabus')";
