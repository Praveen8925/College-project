...
<tr class="tableth"><td colspan="2" align="center">Staff Achievement  Report</td>
</tr>
<tr>
<td>Date From</td>
<td><?php
...
<?php
                   $i=1;
           			  ...
           			  $issue=date_format($issue,"M-Y");
                                  print "<tr><td>$i</td><td>".$row["SID"]."</td><td>".$row["Name"]."</td><td>".$row["Department"]."</td><td>".$row["jptype"]."</td><td>".$row["Title"]."</td><td>".$row["jpname"]."</td><td>".$row["ISBN/ISSN_No"]."</td><td>".$row["Impact_No"]."</td><td>".$row["Volume"]."</td><td>".$issue."</td><td>".$row["Page_No"]."</td><td>";
?>
...
<tr>
<td><center>
<input type="Submit" Value="Export To XL"  onClick="location.href='xlstaffpub.php'" class="bn"></center>
</td>
</tr>
                   ...
                   $i=1;
    	                 while($row=mysql_fetch_assoc($rs))
    	                  {      $date=$row["Date"];
                                 ...
                                 print "<tr><td>$i</td><td>".$row["SID"]."</td><td>".$row["Name"]."</td><td>".$row["Department"]."</td><td>".$row["Level"]."</td><td>".$row["Presentation_Participation"]."</td><td>".$row["Program Name"]."</td><td>".$row["Title"]."</td><td>".$row["Institution Name"]."</td><td>".$date."</td><td>";
?>
                                 <a href='<?php print $row['Certificate'];?>' target='blank'><img src="images/cer2.jpg" title="cer" hspace="15" width="25" height="25"></a></td><td>
...
<tr>
<td><center>
<input type="Submit" Value="Export To XL"  onClick="location.href='XLstaffpp.php'" class="bn"></center>
</td>
</tr>
<?php
                           }
    	                 ...
    	                 while($row=mysql_fetch_assoc($rs))
    	                  {
                                 ...
                                 print "<tr><td>$i</td><td>".$row["SID"]."</td><td>".$row["Name"]."</td><td>".$row["Department"]."</td><td>".$row["Event"]."</td><td>".$row["Program Name"]."</td><td>".$row["Institution Name"]."</td><td>".$date1."</td><td>$difference</td><td>";
?>
...
<tr>
<td><center>
<input type="Submit" Value="Export To XL"  onClick="location.href='XLstaffworkshop.php'" class="bn"></center>
</td>
</tr>
<?php
                            }
...
?>
<table cellspacing="10" class="font-stylec" width="100%">
<tr class="tableth"><td colspan="2" align="center">100% Result Achievement  Report</td>
</tr>
</table>
<?php
                                  $fdate=date_create($fdate);
...
<?php
    	                   ...
    	                   while($row=mysql_fetch_assoc($rs))
    	                              {
                                       print "<tr><td>$i</td><td>".$row["SID"]."</td><td>".$row["Name"]."</td><td>".$row["Department"]."</td><td>".$row["Course Name"]."</td><td>".$row["Year"]."</td><td>".$row["Semister"]."</td><td>";
                                     $i=$i+1;        
...
<tr>
<td><center>
<input type="Submit" Value="Export To XL"  onClick="location.href='XLstaffresult.php'" class="bn"></center>
</td>
</tr>
<?php
