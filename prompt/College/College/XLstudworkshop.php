<?php
	  ...
	  header("Expires: 0");
          $sep = "\t";
                 ...
                 echo "SI.No\tReg_No \t Name \t Department \t Program Name \t Institution Name\t Date\t No.of.days  ";
      ...
      {  
        ...
        $schema_insert = "";
        print "$i\t".$row["RegNo"]."\t".$row["Name"]."\t".$row["Department"]."\t".$row["Program_Name"]."\t".$row["Institution_Name"]."\t".$date1."\t".$difference."\t";
