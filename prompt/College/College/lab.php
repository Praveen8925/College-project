...
<div class="allblur">
   ...
   <tr>
     <td colspan="2" align="Center"><h1>Record And Lab Performance</h1>
   </tr>
   <tr>
     <td colspan="2" align="Center"><h3>
<?php 
  if(isset($_SESSION['record']))
     print $_SESSION['record'];
  unset($_SESSION['record']);
?></h3>
   </tr>
<form name="recordlab" method="post" action="#" >
   <tr>
       <td>Batch</td>
...
<?php
      if(isset($_POST['tp']))
      {
       if($_POST['tp']=='Record')
        {
?>
<input type="radio" name="tp" id="tp" value="Record" checked="checked">Record
<input type="radio" name="tp"  id="tp" value="Lab Performance">Lab Performance
<?php
        ...
        {
?>
<input type="radio" name="tp" id="tp" value="Record" >Record
<input type="radio" name="tp"  id="tp" value="Lab Performance" checked="checked">Lab Performance
<?php    
        }
      }
      else
...
?>
<form name="lab" method="post"  action="labSave.php" >
...
<input type="hidden" name="type" id="type"  value="<?php print $tp; ?>"  size="30">
...
<?php 
                                   ...
                                   $SQL="SELECT * FROM collegedetails.$table WHERE Batch='$batch' and RegNo='$reg' and sem='$sem' and  type='$tp'";
                                   $rm=mysql_query($SQL);
...
<?php
 ...
 ?>
<td><input type="text" name="mark[<?php print $i;?>][<?php print $j;?>]" id="mark[<?php print $i;?>][<?php print $j;?>]" size="3" <?php print $d; ?> maxlength="2" value="<?php print $mar[$j-1];?>" ></td>
<?php
                                                                 }
                                                           }
