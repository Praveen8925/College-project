...
<div class="allblur">
   ...
   <tr>
     <td colspan="2" align="Center"><h1>Model Exam Time Table</h1>
   </tr>
   <tr>
               ...
               $rs=mysql_query($SQL);  
                    if (mysql_num_rows($rs)==0)
                     ...
                     if($d=='n')
                       {
?>
<form name="modelexamtimetable" method="post" action="ModelExamTimeTableSave.php" >
...
<?php
                      ...
                      $SQL="SELECT * FROM  modelexam WHERE  CourseID='$cid'";
                       $rm=mysql_query($SQL);
                       $decided="";
...
?>
<input type="Text" id="dat[<?php print $i; ?>]" name="dat[<?php print $i; ?>]" maxlength="10" size="10" value="<?php echo $ME_Date; ?>" <?php print $d; if($d==""){ ?> onClick="javascript:NewCssCal('dat[<?php print $i; ?>]','DDMMYYYY')" style="cursor:pointer" <?php } ?> /></td><td>
