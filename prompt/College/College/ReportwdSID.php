...
<?php
             ...
             $tdate=date_format($tdate,"y-m-d");
               $SQL= "select * from workdiarys where SID='$sid' AND DATE >= '$fdate' AND DATE <= '$tdate'  ORDER BY DATE ASC,Hour ASC" ;
               ...
               $rs=mysql_query($SQL);  
			    ...
			    $date=$row["DATE"];
                 ...
                 $remark=$row["Remark"];
                 if($remark=="OD")
                  print "<td colspan='5' align='center'>OD</td>";
                 else if($remark=="CL")
                  print "<td colspan='5' align='center'>Leave</td>";
                 else
                     {  
