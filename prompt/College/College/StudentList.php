...
?>
<a href="StudentOperation.php?action=Edit&id=<?php print $row['RegNo'] ?>"><img src="images/Edit.png" title="Edit" hspace="5" width="25" height="20"></a><a href="StudentOperation.php?action=Delete&id=<?php print $row['RegNo'] ?>"><img src="images/delete3.jpg" title="Delete" hspace="5" width="25" height="20"></a></td></tr>	
<?php
$i=$i+1;
    	      }
          }
